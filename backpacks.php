...
<head>
  ...
  <meta charset="UTF-8">
  <title>Bear Tribleas | Backpacks</title>
  <style>
...
<body>
  ...
  <nav class="category-nav">
    ...
    <a href="backpacks.php" class="cat-item active"><img src="https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=150&q=80" alt="Backpacks"><span>Backpacks</span></a>
  </nav>

  <div class="hero" style="background-image:url('https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=1600&q=80');">
    <div class="hero-content">
      <h1 style="font-size:4rem;text-transform:uppercase;letter-spacing:2px;">Backpacks</h1>
    </div>
  </div>
  ...
  <section class="content-section">
    <div class="grid">
      <div class="minimalist-card">
        <img src="https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=400&q=80" class="product-image">
        <div class="card-content">
          <h3 class="card-title">Basecamp Daypack</h3>
          <select id="variant-601" class="variant-select"><option value="3499">20L — ₹3,499</option></select>
          <input type="number" id="qty-601" class="qty-input-full" value="1" min="1" max="20">
          <button class="add-btn-small" onclick="addVariantToCart(601,'Basecamp Daypack','https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=400&q=80')">ADD TO CRATE</button>
        </div>
      </div>
      <div class="minimalist-card">
        <img src="https://images.unsplash.com/photo-1622560480605-d83c853bc5c3?auto=format&fit=crop&w=400&q=80" class="product-image">
        <div class="card-content">
          <h3 class="card-title">Trail Runner Pack</h3>
          <select id="variant-602" class="variant-select"><option value="2899">15L — ₹2,899</option></select>
          <input type="number" id="qty-602" class="qty-input-full" value="1" min="1" max="20">
          <button class="add-btn-small" onclick="addVariantToCart(602,'Trail Runner Pack','https://images.unsplash.com/photo-1622560480605-d83c853bc5c3?auto=format&fit=crop&w=400&q=80')">ADD TO CRATE</button>
        </div>
      </div>
      <div class="minimalist-card">
        <img src="https://images.unsplash.com/photo-1491637639811-60e2756cc1c7?auto=format&fit=crop&w=400&q=80" class="product-image">
        <div class="card-content">
          <h3 class="card-title">Frontier Rucksack</h3>
          <select id="variant-603" class="variant-select"><option value="4599">30L — ₹4,599</option></select>
          <input type="number" id="qty-603" class="qty-input-full" value="1" min="1" max="20">
          <button class="add-btn-small" onclick="addVariantToCart(603,'Frontier Rucksack','https://images.unsplash.com/photo-1491637639811-60e2756cc1c7?auto=format&fit=crop&w=400&q=80')">ADD TO CRATE</button>
        </div>
      </div>
    </div>
  </section>
