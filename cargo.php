...
<head>
  ...
  <meta charset="UTF-8">
  <title>Bear Tribleas | Cargo</title>
  <style>
...
<body>
  ...
  <nav class="category-nav">
    ...
    <a href="cargo.php" class="cat-item active"><img src="https://images.unsplash.com/photo-1542272604-787c3835535d?w=150&q=80" alt="Cargo &amp; Denim"><span>Cargo &amp; Denim</span></a>
  ...
  <div class="hero" style="background-image:url('https://images.unsplash.com/photo-1542272604-787c3835535d?auto=format&fit=crop&w=1600&q=80');">
    <div class="hero-content">
      <h1 style="font-size:4rem;text-transform:uppercase;letter-spacing:2px;">Cargo</h1>
    </div>
  </div>
  ...
  <section class="content-section">
    <div class="grid">
      <div class="minimalist-card">
        <img src="https://images.unsplash.com/photo-1517438322307-e67111335449?auto=format&fit=crop&w=400&q=80" class="product-image">
        <div class="card-content">
          <h3 class="card-title">Utility Cargo Pants</h3>
          <select id="variant-301" class="variant-select"><option value="2199">Size 32 — ₹2,199</option></select>
          <input type="number" id="qty-301" class="qty-input-full" value="1" min="1" max="20">
          <button class="add-btn-small" onclick="addVariantToCart(301,'Utility Cargo Pants','https://images.unsplash.com/photo-1517438322307-e67111335449?auto=format&fit=crop&w=400&q=80')">ADD TO CRATE</button>
        </div>
      </div>
      <div class="minimalist-card">
        <img src="https://images.unsplash.com/photo-1542272604-787c3835535d?auto=format&fit=crop&w=400&q=80" class="product-image">
        <div class="card-content">
          <h3 class="card-title">Wilderness Multi-Pocket</h3>
          <select id="variant-302" class="variant-select"><option value="2499">Size 34 — ₹2,499</option></select>
          <input type="number" id="qty-302" class="qty-input-full" value="1" min="1" max="20">
          <button class="add-btn-small" onclick="addVariantToCart(302,'Wilderness Multi-Pocket','https://images.unsplash.com/photo-1542272604-787c3835535d?auto=format&fit=crop&w=400&q=80')">ADD TO CRATE</button>
        </div>
      </div>
      <div class="minimalist-card">
        <img src="https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?auto=format&fit=crop&w=400&q=80" class="product-image">
        <div class="card-content">
          <h3 class="card-title">Midnight Cargo Pants</h3>
          <select id="variant-303" class="variant-select"><option value="3299">Size 32 — ₹3,299</option></select>
          <input type="number" id="qty-303" class="qty-input-full" value="1" min="1" max="20">
          <button class="add-btn-small" onclick="addVariantToCart(303,'Midnight Cargo Pants','https://images.unsplash.com/photo-1624378439575-d8705ad7ae80?auto=format&fit=crop&w=400&q=80')">ADD TO CRATE</button>
        </div>
      </div>
      <div class="minimalist-card">
        <img src="https://images.unsplash.com/photo-1555689502-c4b22d76c56f?auto=format&fit=crop&w=400&q=80" class="product-image">
        <div class="card-content">
          <h3 class="card-title">Nomad Canvas Trousers</h3>
          <select id="variant-304" class="variant-select"><option value="3899">Size 34 — ₹3,899</option></select>
          <input type="number" id="qty-304" class="qty-input-full" value="1" min="1" max="20">
          <button class="add-btn-small" onclick="addVariantToCart(304,'Nomad Canvas Trousers','https://images.unsplash.com/photo-1555689502-c4b22d76c56f?auto=format&fit=crop&w=400&q=80')">ADD TO CRATE</button>
        </div>
      </div>
    </div>
  </section>
