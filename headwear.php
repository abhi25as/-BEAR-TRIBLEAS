...
<head>
  <meta charset="UTF-8">
  <title>Bear Tribleas | Headwear</title>
  <style>
...
<body>
  ...
  <nav class="category-nav">
    ...
    <a href="headwear.php" class="cat-item active"><img src="https://images.unsplash.com/photo-1576871337622-98d48d1cf531?w=150&q=80" alt="Headwear"><span>Headwear</span></a>
  ...
  <div class="hero" style="background-image:url('https://images.unsplash.com/photo-1576871337622-98d48d1cf531?auto=format&fit=crop&w=1600&q=80');">
    <div class="hero-content">
      <h1 style="font-size:4rem;text-transform:uppercase;letter-spacing:2px;">Headwear</h1>
    </div>
  </div>
  ...
  <section class="content-section">
    <div class="grid">
      <div class="minimalist-card">
        <img src="https://images.unsplash.com/photo-1576871337622-98d48d1cf531?auto=format&fit=crop&w=400&q=80" class="product-image">
        <div class="card-content">
          <h3 class="card-title">Urban Bear Beanie</h3>
          <select id="variant-401" class="variant-select"><option value="699">One Size — ₹699</option></select>
          <input type="number" id="qty-401" class="qty-input-full" value="1" min="1" max="20">
          <button class="add-btn-small" onclick="addVariantToCart(401,'Urban Bear Beanie','https://images.unsplash.com/photo-1576871337622-98d48d1cf531?auto=format&fit=crop&w=400&q=80')">ADD TO CRATE</button>
        </div>
      </div>
      <div class="minimalist-card">
        <img src="https://images.unsplash.com/photo-1588850561407-ed78c282e89b?auto=format&fit=crop&w=400&q=80" class="product-image">
        <div class="card-content">
          <h3 class="card-title">Trail Dad Cap</h3>
          <select id="variant-402" class="variant-select"><option value="849">One Size — ₹849</option></select>
          <input type="number" id="qty-402" class="qty-input-full" value="1" min="1" max="20">
