...
<head>
  <meta charset="UTF-8">
  <title>Bear Tribleas | Hoodies</title>
  <style>
    /* Use the same <style> block from tees.php to save space */
...
<body>
  ...
  <nav class="category-nav">
    ...
    <a href="hoodies.php" class="cat-item active"><img src="https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=150&q=80" alt="Hoodies"><span>Hoodies</span></a>
  ...
  <div class="hero" style="background-image:url('https://images.unsplash.com/photo-1556821840-3a63f95609a7?auto=format&fit=crop&w=1600&q=80');">
    <div class="hero-content">
      <h1 style="font-size:4rem;text-transform:uppercase;letter-spacing:2px;">Hoodies</h1>
    </div>
  </div>
  ...
  <section class="content-section">
    <div class="grid">
      <div class="minimalist-card">
        <img src="https://images.unsplash.com/photo-1556821840-3a63f95609a7?auto=format&fit=crop&w=400&q=80" class="product-image">
        <div class="card-content">
          <h3 class="card-title">Grizzly Winter Hoodie</h3>
          <select id="variant-201" class="variant-select"><option value="2799">Medium — ₹2,799</option></select>
          <input type="number" id="qty-201" class="qty-input-full" value="1" min="1" max="20">
          <button class="add-btn-small" onclick="addVariantToCart(201,'Grizzly Winter Hoodie','https://images.unsplash.com/photo-1556821840-3a63f95609a7?auto=format&fit=crop&w=400&q=80')">ADD TO CRATE</button>
        </div>
      </div>
      <div class="minimalist-card">
        <img src="https://images.unsplash.com/photo-1509942774463-acf339cf87d5?auto=format&fit=crop&w=400&q=80" class="product-image">
        <div class="card-content">
          <h3 class="card-title">Essential Fleece Hoodie</h3>
          <select id="variant-202" class="variant-select"><option value="2499">Large — ₹2,499</option></select>
          <input type="number" id="qty-202" class="qty-input-full" value="1" min="1" max="20">
      ...
      <div class="minimalist-card">
        ...
        <div class="card-content">
          <h3 class="card-title">Alpine Heavy Pullover</h3>
          <select id="variant-204" class="variant-select"><option value="3199">XL — ₹3,199</option></select>
          <input type="number" id="qty-204" class="qty-input-full" value="1" min="1" max="20">
          <button class="add-btn-small" onclick="addVariantToCart(204,'Alpine Heavy Pullover','https://images.unsplash.com/photo-1614975059251-992f11792b9f?auto=format&fit=crop&w=400&q=80')">ADD TO CRATE</button>
        </div>
      </div>
    </div>
  </section>
